...
- A reading you delete in your scale's own app now disappears here too. The import only ever added, so it had no way of hearing that something was no longer there, and a reading deleted elsewhere sat in WeightTrack for good. After the first sync the app asks Health Connect what has changed rather than rereading years of history every hour, which is both how it hears about a deletion and a great deal less work. A deletion that arrives this way is recorded properly, so it travels to your other devices instead of being handed back by them.
